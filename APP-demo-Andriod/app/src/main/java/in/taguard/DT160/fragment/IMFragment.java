package in.taguard.DT160.fragment;
...
import in.taguard.DT160.activity.NfcCommandActivity;
import in.taguard.DT160.adapter.RecyclerAdapter;
import in.taguard.DT160.decorator.GridDividerItemDecoration;
import in.taguard.DT160.dialog.Limit2ModeDialog;
import in.taguard.DT160.listener.OnItemClickListener;
import in.taguard.DT160.tools.BroadcastManager;
import in.taguard.DT160.tools.FullScreenDialog;
import in.taguard.DT160.tools.IncomeBean;
import in.taguard.DT160.tools.LineChartManager;
import in.taguard.DT160.util.ActivityUtils;
import in.taguard.DT160.util.BitmapUtils;
import in.taguard.DT160.util.CommonDialog;
import in.taguard.DT160.util.HintDialog;
import in.taguard.DT160.util.LogUtil;
import in.taguard.DT160.util.MyConstant;
import in.taguard.DT160.util.NFCUtils;
import in.taguard.DT160.util.SpUtils;
import in.taguard.DT160.util.TimeUitls;
import in.taguard.DT160.util.TransUtil;
